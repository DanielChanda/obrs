@extends(auth()->user()->role == 'admin' ? 'admin.layouts.app' : 'operator.layouts.app')

@section('title', 'Profile')
@section('page-title', auth()->user()->role == 'admin' ? 'Admin Profile' : 'Operator Profile')
...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route(auth()->user()->role == 'admin' ? 'admin.profile.update' : 'operator.profile.update') }}">
                @csrf
                <div class="mb-3">
